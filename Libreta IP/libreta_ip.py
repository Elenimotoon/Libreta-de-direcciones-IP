...
ruta_imagenes = '.\\Libreta_IP\\Fondos\\'

#↓ imagen de  fondo para la ventana
fond_vent = [camb_imag(ruta_imagenes+'fondo.gif', 900, 500), camb_imag(ruta_imagenes+'fondo2.gif', 900, 500), camb_imag(ruta_imagenes+'fondo3.gif', 900, 500),]
...
tam_botones = [100, 30,]
botones = [camb_imag(ruta_imagenes+'boton-guardar.gif', tam_botones[0], tam_botones[1]), camb_imag(ruta_imagenes+'boton-editar.gif',tam_botones[0], tam_botones[1]),
            camb_imag(ruta_imagenes+'boton-eliminar.gif',tam_botones[0], tam_botones[1]), camb_imag(ruta_imagenes+'boton-excel.gif', tam_botones[0], tam_botones[1]),
            camb_imag(ruta_imagenes+'boton-ping-ipv4.gif', tam_botones[0], tam_botones[1]), camb_imag(ruta_imagenes+'boton-ping-ipv6.gif', tam_botones[0], tam_botones[1]),]


# ↓ etiqueta sirve para identificar donde va el nombre del dispositivo
etiq_disp = tk.Label (ventana) 
